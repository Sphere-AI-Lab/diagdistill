...
class CausalInferencePipeline(torch.nn.Module):
    def __init__(
        ...
        self.not_use_clean_context_kv_update = bool(getattr(args, "not_use_clean_context_kv_update", False))
    ...
    def inference(
        ...
        for block_index, current_num_frames in enumerate(all_num_frames):
            ...
            # Step 2.3: optional KV cache refresh policy controlled by config
            if not self.not_use_clean_context_kv_update:
                # New behavior: refresh only for non-last blocks using clean context at t=0
                ...
                # Previous behavior: refresh every block using context_noise
